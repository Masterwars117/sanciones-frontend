<template>
  <div>
    <div class="head">
      <div>
        <h1 class="title" style="font-weight: bold; font-size: 40px;">
    Nuevo registro estatal</h1>
    ...
    <div class="card">
      <div v-if="cargandoCatalogos" class="empty">
        Cargando catálogos...
      </div>
        ...
        <div class="form-sections">
          <section class="section-card">
            <div class="section-head">
              ...
              <p class="section-text">Datos base para alta del registro estatal.</p>
            </div>
...
async function guardar() {
  ...
  if (!form.anio.trim() || !form.sancionid.trim()) {
    error.value = "Año y Sanción ID son obligatorios."
    return
  }
